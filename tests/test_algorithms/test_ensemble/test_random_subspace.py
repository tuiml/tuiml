"""Test suite for RandomSubspaceClassifier.
...
class TestRandomSubspaceClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = RandomSubspaceClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = RandomSubspaceClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestRandomSubspaceClassifierFitting:
...
class TestRandomSubspaceClassifierSerialization:
