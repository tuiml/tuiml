"""Test suite for MultiClassClassifier.
...
class TestMultiClassClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = MultiClassClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = MultiClassClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestMultiClassClassifierFitting:
...
class TestMultiClassClassifierSerialization:
