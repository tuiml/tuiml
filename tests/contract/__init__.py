...
runs it: the check functions live here, and the ``tests/test_common_*.py``
modules parametrise them over whatever the registry currently holds. Adding a
component subscribes it to its family's whole battery; adding a check here
applies it to every component in that family at once.
