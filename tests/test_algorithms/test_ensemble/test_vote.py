"""Test suite for VotingClassifier.
...
class TestVotingClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = VotingClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = VotingClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestVotingClassifierFitting:
...
class TestVotingClassifierSerialization:
