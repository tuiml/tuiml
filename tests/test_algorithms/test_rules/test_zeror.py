"""Test suite for ZeroRuleClassifier.
...
class TestZeroRuleClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = ZeroRuleClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = ZeroRuleClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestZeroRuleClassifierFitting:
...
class TestZeroRuleClassifierSerialization:
