"""Test suite for OneRuleClassifier.
...
class TestOneRuleClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = OneRuleClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = OneRuleClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestOneRuleClassifierFitting:
...
class TestOneRuleClassifierSerialization:
