...
class TestDBSCANClustererInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = DBSCANClusterer.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = DBSCANClusterer.get_capabilities()
        assert isinstance(caps, list)


class TestDBSCANClustererFitting:
...
class TestDBSCANClustererSerialization:
