"""Test suite for FilteredClassifier.
...
class TestFilteredClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = FilteredClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = FilteredClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestFilteredClassifierFitting:
...
class TestFilteredClassifierSerialization:
