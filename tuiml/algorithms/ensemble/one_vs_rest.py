...
class OneVsRestClassifier(Classifier):
    ...
    OneVsRestClassifier enables **binary classifiers** to handle multi-class
    ...
    **ECOC:**
    ...
    Parameters
    ----------
    base_classifier : str or class, default='SVC'
    ...
    **When to use OneVsRestClassifier:**
    ...
    def __init__(self, base_classifier: Any = 'SVC',
                 method: str = 'ova',
    ...
    def _fit_ova(self, X: np.ndarray, y_idx: np.ndarray):
        ...
        for k in range(self.n_classes_):
            ...
            estimator = make_base_estimator(self._base_class, self.random_state)
    ...
    def __repr__(self) -> str:
        if self._is_fitted:
            return f"OneVsRestClassifier(base={self.base_classifier}, method={self.method})"
        return f"OneVsRestClassifier(base_classifier={self.base_classifier})"
