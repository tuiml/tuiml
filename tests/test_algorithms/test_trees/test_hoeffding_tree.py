"""Test suite for HoeffdingTreeClassifier.
...
class TestHoeffdingTreeClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = HoeffdingTreeClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = HoeffdingTreeClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestHoeffdingTreeClassifierFitting:
...
class TestHoeffdingTreeClassifierSerialization:
