"""Test suite for StackingClassifier.
...
class TestStackingClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = StackingClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = StackingClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestStackingClassifierFitting:
...
class TestStackingClassifierSerialization:
