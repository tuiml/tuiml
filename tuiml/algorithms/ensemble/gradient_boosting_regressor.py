...
class GradientBoostingRegressor(Regressor):
    ...
    Builds an additive ensemble by iteratively fitting base regressors to the
    residuals (negative gradients) of the previous predictions.
    ...
    def __repr__(self) -> str:
        ...
        if self._is_fitted:
            return (f"GradientBoostingRegressor(n_estimators={len(self.estimators_)}, "
