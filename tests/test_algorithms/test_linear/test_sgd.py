...
class TestSGDClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = SGDClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = SGDClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestSGDClassifierFitting:
...
class TestSGDClassifierSerialization:
