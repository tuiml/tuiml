"""Test suite for DecisionStumpClassifier.
...
class TestDecisionStumpClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = DecisionStumpClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = DecisionStumpClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestDecisionStumpClassifierFitting:
...
class TestDecisionStumpClassifierSerialization:
