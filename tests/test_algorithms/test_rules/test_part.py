...
class TestPARTClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = PARTClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = PARTClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestPARTClassifierFitting:
...
class TestPARTClassifierSerialization:
