"""Test suite for BayesianNetworkClassifier.
...
class TestBayesianNetworkClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = BayesianNetworkClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = BayesianNetworkClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestBayesianNetworkClassifierFitting:
...
class TestBayesianNetworkClassifierSerialization:
