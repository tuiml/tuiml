"""Test suite for CatBoostClassifier.
...
class TestCatBoostClassifierInstantiation:
    ...
    def test_parameter_schema(self):
        ...
        schema = CatBoostClassifier.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = CatBoostClassifier.get_capabilities()
        assert isinstance(caps, list)


class TestCatBoostClassifierFitting:
...
class TestCatBoostClassifierSerialization:
