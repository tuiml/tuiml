...
class SklearnGradientBoostingRegressor(Regressor):
    """
    Gradient Boosting for regression using Scikit-Learn.
    ...
    def __repr__(self) -> str:
        ...
        return f"SklearnGradientBoostingRegressor(n_estimators={self.n_estimators}, learning_rate={self.learning_rate})"
