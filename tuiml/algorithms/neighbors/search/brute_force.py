...
class BruteForceSearch(NearestNeighborSearch):
    ...
    **When to use BruteForceSearch:**
    ...
    def build(self, X: np.ndarray) -> "BruteForceSearch":
    ...
    def __repr__(self) -> str:
        ...
        if self._is_built:
            return f"BruteForceSearch(n_samples={self.n_samples_})"
        return "BruteForceSearch(not built)"
