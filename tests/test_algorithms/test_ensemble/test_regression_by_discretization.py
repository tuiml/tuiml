"""Test suite for RegressionByDiscretization.
...
class TestRegressionByDiscretizationInstantiation:
    """Tests for algorithm instantiation."""
    
    def test_default_initialization(self):
        """Test default initialization."""
        model = RegressionByDiscretization()
        assert model is not None
        assert model._is_fitted is False
        
    def test_parameter_schema(self):
        """Test parameter schema."""
        schema = RegressionByDiscretization.get_parameter_schema()
        assert isinstance(schema, dict)
        
    def test_capabilities(self):
        """Test capabilities."""
        caps = RegressionByDiscretization.get_capabilities()
        assert isinstance(caps, list)


class TestRegressionByDiscretizationFitting:
...
class TestRegressionByDiscretizationSerialization:
